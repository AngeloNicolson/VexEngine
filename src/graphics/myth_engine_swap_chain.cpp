...
VkSurfaceFormatKHR MythEngineSwapChain::chooseSwapSurfaceFormat(
...
VkPresentModeKHR MythEngineSwapChain::chooseSwapPresentMode(
...
VkExtent2D MythEngineSwapChain::chooseSwapExtent(
