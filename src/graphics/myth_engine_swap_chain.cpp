...
MythEngineSwapChain::MythEngineSwapChain(MythEngineDevice &deviceRef, VkExtent2D extent)
...
VkResult MythEngineSwapChain::acquireNextImage(uint32_t *imageIndex)
{
...
VkResult MythEngineSwapChain::submitCommandBuffers(const VkCommandBuffer *buffers, uint32_t *imageIndex)
{
...
void MythEngineSwapChain::createSwapChain()
{
...
void MythEngineSwapChain::createImageViews()
{
...
void MythEngineSwapChain::createRenderPass()
{
...
void MythEngineSwapChain::createFramebuffers()
{
...
void MythEngineSwapChain::createDepthResources()
{
...
void MythEngineSwapChain::createSyncObjects()
{
...
VkSurfaceFormatKHR MythEngineSwapChain::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR> &availableFormats)
{
...
VkPresentModeKHR MythEngineSwapChain::chooseSwapPresentMode(const std::vector<VkPresentModeKHR> &availablePresentModes)
{
...
VkExtent2D MythEngineSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities)
{
...
VkFormat MythEngineSwapChain::findDepthFormat()
{
