...
{
  Graphics::SwapChain::SwapChain(VulkanDevice& deviceRef, VkExtent2D extent) : device{deviceRef}, windowExtent{extent}
  {
    createSwapChain();
    createImageViews();
    createRenderPass();
  ...
  VkResult Graphics::SwapChain::acquireNextImage(uint32_t* imageIndex)
  {
  ...
  VkResult Graphics::SwapChain::submitCommandBuffers(const VkCommandBuffer* buffers, uint32_t* imageIndex)
  {
  ...
  void Graphics::SwapChain::createRenderPass()
  {
  ...
  void Graphics::SwapChain::createFramebuffers()
  {
  ...
  void Graphics::SwapChain::createSyncObjects()
  {
  ...
  VkSurfaceFormatKHR
  Graphics::SwapChain::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats)
  {
    for(const auto& availableFormat : availableFormats)
      {
        if(availableFormat.format == /*Gamma correction*/ VK_FORMAT_B8G8R8A8_SRGB &&
  ...
  VkExtent2D Graphics::SwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities)
  {
  ...
  VkFormat Graphics::SwapChain::findDepthFormat()
  {
