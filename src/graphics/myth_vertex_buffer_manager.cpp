...
MythVertexBufferManager::MythVertexBufferManager(MythEngineDevice &device, const std::vector<Vertex> &vertices)
    : mythDevice{device}
{
...
void MythVertexBufferManager::createVertexBuffers(const std::vector<Vertex> &vertices)
{
...
std::vector<VkVertexInputBindingDescription> MythVertexBufferManager::Vertex::getBindingDescriptions()
{
