...
namespace GameEngine
{
  namespace Graphics
  {
    ...
    GraphicsPipeline::GraphicsPipeline(VulkanDevice& device, const std::string& vertFilepath,
    ...
    PipelineConfigInfo GraphicsPipeline::defaultPipelineConfigInfo(uint32_t width, uint32_t height)
    {
      ...
      configInfo.inputAssemblyInfo.topology =
        VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST;                          // List - every 3 vertices = 1 triangle
